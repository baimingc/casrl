...
@LastEditTime: 2020-05-18 00:21:39
@Description: 
'''
            ...
            for epi in range(gym_config['subtask_episode']): # each subtask contains a fixed number of episode
                ...
                while not done:
                    ...
                    if done:
                        ...
                        dumb_reward_plot(path, PREFIX='HalfCheetah', xlim=[0, 200], ylim=[-150, 100], y_line1=100, y_line2=100)
                        dumb_predict_error_plot(path, PREFIX='HalfCheetah', ylim=[0, 5])
