    ...
    def train(self):
        ...
        with self.sess.as_default() as sess:
            ...
            for itr in range(self.start_itr, self.n_itr):
                ...
                # when obtain samples, n_parallel will be used to perform parallel
                # num_roll environments will be created to collect data, each environment will collect max_path_length data
