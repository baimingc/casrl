...
class MAML_continual_truncBackprop:
    def __init__(self, regressor, k, validation_set_size, ignore_absolute_xy, agent_type,
                dim_input_regressor=1, dim_input=1, dim_output=1, dim_bias=1, BACKWARD_LENGTH=10, config={}):
    ...
    def construct_model(self, input_tensors=None, prefix='metatrain_'):
        ...
        with tf.variable_scope('model', reuse=None) as training_scope:
            ...
            for timestep in range(2*self.k, 2*self.k+self.max_num_steps):
                ...
                if(timestep==(2*self.k+self.max_num_steps-self.BACKWARD_LENGTH)):
                    backprop_to_here_b0 = b0
                    backprop_to_here_b1 = b1
                    backprop_to_here_b2 = b2
                    backprop_to_here_b3 = b3
                    backprop_to_here_W0 = W0
                    backprop_to_here_W1 = W1
                    backprop_to_here_W2 = W2
                    backprop_to_here_W3 = W3
                    backprop_to_here_bias = bias
        ...
        self.this_grad_b0 = tf.gradients(self.loss_for_this_theta, backprop_to_here_b0)[0] 
        self.this_grad_b1 = tf.gradients(self.loss_for_this_theta, backprop_to_here_b1)[0]
        self.this_grad_b2 = tf.gradients(self.loss_for_this_theta, backprop_to_here_b2)[0]
        self.this_grad_b3 = tf.gradients(self.loss_for_this_theta, backprop_to_here_b3)[0]
        self.this_grad_W0 = tf.gradients(self.loss_for_this_theta, backprop_to_here_W0)[0]
        self.this_grad_W1 = tf.gradients(self.loss_for_this_theta, backprop_to_here_W1)[0]
        self.this_grad_W2 = tf.gradients(self.loss_for_this_theta, backprop_to_here_W2)[0]
        self.this_grad_W3 = tf.gradients(self.loss_for_this_theta, backprop_to_here_W3)[0]
        self.this_grad_bias = tf.gradients(self.loss_for_this_theta, backprop_to_here_bias)[0]
