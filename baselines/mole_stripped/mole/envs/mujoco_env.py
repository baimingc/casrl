...
class MujocoEnv(Env):
    ...
    def reset_mujoco(self, init_state=None):
        ...
        if init_state is None:
            ...
            self.model.data.qpos = init_state[0]
            self.model.data.qvel = init_state[1]
            self.model.data.qacc = init_state[2]
            self.model.data.ctrl = init_state[3]
