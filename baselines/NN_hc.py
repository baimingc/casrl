...
@LastEditTime: 2020-05-13 18:14:52
@Description:
'''
...
class NN(object):
    ...
    def data_process(self, data):
        ...
        data = np.concatenate((s[:, 1:], a), axis=1)
        ...
        for epoch in range(self.n_epochs):
            ...
            for datas, labels in train_loader:
                ...
                if train_x is None:
                    ...
                    train_x = torch.cat((train_x, datas), dim=0)
