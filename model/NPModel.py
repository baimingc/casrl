...
class NeuralProcessModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.mlp_hidden_size_list_decoder = mlp_hidden_size_list_decoder
        ...
        self._decoder = Decoder(x_dim=self.x_dim,
                                y_dim=self.y_dim,
                                mid_hidden_dim_list=self.mlp_hidden_size_list_decoder,
    ...
    def forward(self, context_x, context_y, target_x, target_y=None, print_latent=False):
